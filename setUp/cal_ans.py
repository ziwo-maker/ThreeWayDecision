...
def main():
    ...
    for data_ in data_all:
        ...
        score_rouge_raw=get_best_score(stand_ans,raw_query)[0]['rouge-1']['r']  #没有对话历史
        score_rouge_all=get_best_score(stand_ans,all_query)[0]['rouge-1']['r']  #全部对话历史
...
def main2():
    ...
    for data_ in data_all:
        ...
        raw_query_list.append(select_history[0]['answer_his'])  #所有对话历史
        all_query_list.append(select_history[1]['answer_his'])  #没有对话历史 
        party_list.append(select_history[-1]['answer_his'])#select 对话历史
